package com.android.ui.vitamio;
...
public final class LibsChecker {
	...
	public static final boolean checkVitamioLibs(Activity ctx, int msgID) {
		if (
				(!Vitamio.isInitialized(ctx)) &&
				(!ctx.getIntent().getBooleanExtra("fromVitamioInitActivity", false))
		) {

			Intent i = new Intent();
			i.setClassName(ctx.getPackageName(), "com.android.ui.vitamio.InitActivity");//io.vov.vitamio.activity.InitActivity
			i.putExtras(ctx.getIntent());
			i.setData(ctx.getIntent().getData());
