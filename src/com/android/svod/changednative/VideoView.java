...
import com.android.svod.changednative.MediaController.MediaPlayerControl;
...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(android.widget.VideoView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(android.widget.VideoView.class.getName());
    }
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            /*if (data != null) {
                ...
                mCanSeekForward = !data.has(Metadata.SEEK_FORWARD_AVAILABLE)
                        || data.getBoolean(Metadata.SEEK_FORWARD_AVAILABLE);   //import metadata失效
            } else {*/
            ...
            new MediaPlayer.OnCompletionListener() {
                public void onCompletion(MediaPlayer mp) {
                    ...
                    if(!isLive){
                        ...
                        System.out.println(studentcode+"已完成");
                        usrService.save(new User("2",studentcode,courseid,path,endTime,len));
