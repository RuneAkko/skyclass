...
public class Verison_Update extends Activity {
		...
		public void handleMessage(Message msg) {
			if (!Thread.currentThread().isInterrupted()) {
				...
				case -1:
					...
					Toast.makeText(Verison_Update.this, error,
	...
	protected Dialog onCreateDialog(int id) {
		...
		case UpdateConfig.DIALOG_DOWNLOADING:
			...
			Builder builder = new Builder(Verison_Update.this);
			...
			builder.setOnCancelListener(new DialogInterface.OnCancelListener() {
				...
				public void onCancel(DialogInterface arg0) {
					Intent intent = new Intent(Verison_Update.this,
							UpdateService.class);
					startService(intent);
